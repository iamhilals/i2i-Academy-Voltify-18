...
function FormField({ label, type, value, onChange, placeholder, isDark, icon }) {
  const icons = {
    ...
    <div>
      ...
      <div className="relative">
        ...
        <input type={type} value={value} onChange={(e) => onChange(e.target.value)} placeholder={placeholder}
          className="w-full pl-11 pr-4 py-3 text-sm rounded-full font-body focus:outline-none focus:ring-2"
          style={{
      ...
      <motion.div
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <FormField label="ŞİFRE" type="password" value={password} onChange={setPassword}
            placeholder="••••••••" isDark={isDark} icon="lock" />
